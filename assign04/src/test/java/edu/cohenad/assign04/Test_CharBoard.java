...
public class Test_CharBoard {
    ...
    public void test_toString() {
        ...
        Assert.assertEquals(m.toString(), "5 x 10 edu.cohenad.assign04.CharBoard (default: a)");

        m = new CharBoard(7, 8, '@');
        Assert.assertEquals(m.toString(), "7 x 8 edu.cohenad.assign04.CharBoard (default: @)");
    }
